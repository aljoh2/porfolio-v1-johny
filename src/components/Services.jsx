  ...
  return (
    <section id="services" className="py-24 px-[6%] bg-[var(--bg)]">
      ...
      <div className="grid grid-cols-[repeat(auto-fit,minmax(280px,1fr))] gap-7 max-w-[1100px] mx-auto">
        {items.map((title, i) => (
          <motion.div key={i} className="bg-[var(--bg-2)] border border-[var(--gold-dim)] rounded-2xl p-8 hover:border-[var(--gold)] hover:shadow-[0_8px_30px_rgba(42,127,193,0.15)] transition-all duration-300 cursor-default"
